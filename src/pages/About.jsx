          ...
          <div className="w-full md:w-3/5 lg:w-2/3">
            <div className="space-y-5 md:space-y-6 text-base sm:text-lg text-gray-200 leading-relaxed font-sans">
              ...
              <p>
                ...
                algorithms; it was ensuring inconsistent IoT sensor data didn't
                leave farmers in the dark. I tackled this by implementing robust
                caching and error handling, delivering a system where users
                could trust the near-real-time soil insights, even with spotty
                internet. This drive for user-centric solutions also fueled my
                design for a WhatsApp bot for refugees (RSRS), where enabling
                simple text and voice commands, even photo recognition for
                damaged documents, meant bypassing literacy or language
                barriers.{" "}
                <span className="italic">
                  One user told us, 'Before, I waited weeks for help. Now I get
                  answers while hiding from my abusive husband.' That's the kind
                  of agency I strive to create.
                </span>
              </p>
              <p>
                ...
                This 'low-tech' fix cut lost sales by 40%, allowed me to serve
                25-30% more customers, and even earned comments like, 'This
                feels like VIP service!' It taught me that listening to users
                and finding frugal, empathetic solutions create immense value –{" "}
                <span className="font-medium text-light-green-400">
              ...
              <p>
                ...
                industrial-grade engineering excellence and meaningful networks.{" "}
                <span className="font-medium text-light-green-400">
                  Both are essential for my long-term vision: launching ventures
                  that create over 1,000 jobs and deliver impactful digital
                  solutions for underprivileged communities,
                </span>{" "}
                particularly in agritech and social impact. I'm eager to bring
                this blend of user-centric design, technical problem-solving,
                and entrepreneurial drive to a team that's building truly
