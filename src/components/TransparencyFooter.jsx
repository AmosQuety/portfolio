...
const TransparencyFooter = ({ siteTitle }) => {
  ...
  const isRecruiterMode = activeLens === 'recruiter';
  ...
  return (
    <footer className="mt-20 border-t border-slate-800 bg-slate-950/50 backdrop-blur-md py-12 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className={`flex flex-col md:flex-row justify-between items-center gap-8 ${!isRecruiterMode ? 'pt-8 border-t border-slate-800/50' : ''}`}>
